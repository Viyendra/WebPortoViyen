@php
    $models = $projects->where('type', '!=', 'certification');
...
<body class="antialiased relative overflow-x-hidden selection:bg-blue-500 selection:text-white">
    ...
    <nav class="fixed w-full top-6 z-50 flex justify-center px-4">
        <div class="glass rounded-full px-8 py-4 flex items-center space-x-8 text-sm font-medium shadow-2xl">
            ...
            <a href="#projects" class="text-gray-300 hover:text-white transition">Models</a>
    ...
    <main class="max-w-6xl mx-auto px-6 pt-40 pb-20 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
            ...
            <div class="md:col-span-8">
                ...
                <p class="text-gray-400 text-lg leading-relaxed max-w-2xl mb-8">
                    I specialize in predictive analytics, statistical modeling, and extracting actionable insights from complex datasets. From building robust ensemble models for big data challenges to deploying scalable machine learning solutions.
                </p>

                <div class="flex items-center space-x-4">
                    <a href="https://wa.me/6281261455645" class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-full font-medium transition shadow-[0_0_20px_rgba(37,99,235,0.4)]">
                        Contact Me
                    </a>
                    <div class="flex space-x-3 ml-4 glass px-6 py-3 rounded-full">
                        <a href="https://github.com/Viyendra" class="text-gray-400 hover:text-white transition">
                        ...
                        <a href="https://www.linkedin.com/in/muhammad-viyendra-916a09272/" class="text-gray-400 hover:text-white transition">
        ...
        <div class="glass rounded-2xl p-8 mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-white/10 text-center">
            ...
            <div>
                ...
                <p class="text-gray-500 text-sm font-medium">Data Competitions</p>
            </div>
            <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16" id="about">
            ...
            <div class="glass rounded-3xl p-8 relative overflow-hidden flex flex-col justify-between border border-white/5">
                ...
                <div>
                    ...
                    <p class="text-gray-400 text-sm leading-relaxed">
                        I approach data with deep curiosity and rigorous validation. Whether tuning hyper-parameters or engineering new features, I focus on building models that generalize well.
                    </p>
                </div>
            </div>
            ...
            <div class="md:col-span-2 glass rounded-3xl p-8 flex flex-col md:flex-row gap-8 items-start border border-white/5">
                ...
                <div class="w-full md:w-1/2">   
                    ...
                    <p class="text-gray-400 text-sm leading-relaxed">
                        My expertise lies in transforming raw data into strategic assets. I believe the best machine learning models are built with a deep understanding of domain logic, thorough EDA, and an obsession with preventing data leakage.
                    </p>
                </div>
            </div>
            ...
            <div class="glass rounded-3xl p-8 border border-white/5">
                ...
                <div class="flex flex-wrap gap-2.5">
                    ...
                    <span class="px-4 py-1.5 bg-transparent border border-white/20 rounded-full text-sm text-gray-300 hover:border-blue-400 hover:text-white transition">Pandas</span>
                    <span class="px-4 py-1.5 bg-transparent border border-white/20 rounded-full text-sm text-gray-300 hover:border-blue-400 hover:text-white transition">SQL</span>
                </div>
            </div>

            <div class="md:col-span-2 rounded-3xl p-8 bg-gradient-to-br from-slate-900/80 to-blue-900/40 border border-blue-500/20 flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
                <div>
                    <h3 class="text-2xl font-bold text-white mb-2">Committed to Collaboration</h3>
                    <p class="text-blue-200 text-sm max-w-md mx-auto sm:mx-0">Experience in competitive data science teamwork across academic and enterprise projects.</p>
                </div>
                <a href="https://wa.me/6281261455645" target="_blank" class="inline-block mt-4 px-8 py-2.5 rounded-full hover:scale-105 transition-all duration-300 shadow-lg" style="background-color: #ffffff; color: #020617; font-weight: 900;">
                    Let's Talk
                </a>
            </div>
        ...
        <div id="projects" style="margin-top: 28px;">

            <div class="mb-12 flex flex-col gap-3">
                <h2 class="text-3xl font-extrabold text-white tracking-tight">Machine Learning Models</h2>
                <p class="text-gray-400 text-sm">Eksplorasi data, implementasi algoritma, dan hasil prediksi metrik.</p>
            </div>
                ...
                <div class="glass rounded-[2rem] p-8 flex flex-col justify-between border border-white/10 relative group hover:border-blue-500/50 hover:bg-slate-800/50 transition duration-300 shadow-xl overflow-hidden">
                    ...
                    <div class="relative z-10 flex items-center mt-auto">
                        <a href="{{ route('project.show', $project->slug) }}" 
                           class="w-full text-center font-bold bg-blue-600 hover:bg-blue-500 text-white px-5 py-3.5 rounded-xl transition shadow-[0_0_15px_rgba(37,99,235,0.2)]">
                            Lihat Detail & Model
                        </a>
                    </div>
                </div>
            @empty
                <div class="col-span-2 text-center py-20 glass border border-dashed border-slate-700/50 rounded-[2rem] text-gray-500">
                    Belum ada model machine learning yang di-upload.
                </div>
            @endforelse
        </div>
    </div> @if($certifications->count() > 0)
    <div id="certifications" class="border-t border-white/10" style="margin-top: 28px; padding-top: 28px;">
        <div class="mb-12 flex flex-col gap-3">
                ...
                <p class="text-gray-400 text-sm">Validasi keahlian teknis dan pencapaian profesional.</p>
            </div>
